...
import { contests, questions as allQuestions } from '../data/mockData';
    ...
    return (
        <div className="bg-brand-light min-h-[calc(100vh-128px)] flex items-center justify-center py-12 relative overflow-hidden">
            ...
            <div className="relative max-w-md mx-auto px-4 text-center bg-white p-10 rounded-lg shadow-lg z-10">
                ...
                <p className="text-gray-600 mt-2">{passed ? `You passed the contest!` : `Results will be announced soon. Good effort!`}</p>
...
const ConfirmationModal: React.FC<{ onConfirm: () => void; onCancel: () => void; }> = ({ onConfirm, onCancel }) => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
            ...
            <p className="my-4 text-gray-600">Are you sure you want to submit the contest?</p>
...
const ContestScreen: React.FC = () => {
    ...
    // Note: Using `testId` property in question data for both practice tests and contests
    const questions = useMemo(() => allQuestions.filter(q => q.testId === parseInt(contestId || '')), [contestId]);
    ...
    const [timeLeft, setTimeLeft] = useState(() => contest?.duration ? contest.duration * 60 : 0);
        ...
        return (
            <div className="text-center py-20 bg-brand-light min-h-[calc(100vh-128px)]">
                <div className="bg-white p-8 max-w-lg mx-auto rounded-lg shadow-md">
                    <h2 className="text-2xl font-bold text-brand-navy">Contest not found or has no questions.</h2>
    ...
    if (isSubmitted && score) {
        return (
            <TestResultScreen
                score={score}
                onBack={() => navigate('/contest')}
                message="Back to Contests"
            />
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex justify-between items-center border-b pb-4 mb-4">
                        <h1 className="text-xl sm:text-2xl font-bold text-brand-navy">{contest.name}</h1>
